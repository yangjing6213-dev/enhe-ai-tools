...
export const dictionaries = {
  zh: {
    ...
    toolCard: {
      ...
      priceLabel: "价格",
      deliveryLabel: "交付",
      deliveryDownload: "下载/安装说明",
      deliverySkill: "ZIP 包/安装说明",
      deliveryService: "服务说明",
      deliveryCourse: "课程内容",
      compareBeforeBuy: "先看详情",
      getFreeTool: "免费下载/立即获取",
      capabilityAccess: "权限清晰",
      capabilitySoftware: "软件应用",
      capabilitySkill: "AI Skill",
    ...
    listing: {
      ...
      aiSkillTitle: "AI Skill",
      aiSkillIntro: "查找可安装到 Codex、OpenClaw、Claude Code、Cursor 等智能体中的专业 Skill，购买后获取 ZIP 包和使用说明。",
      onlineTitle: "AI账号服务",
      onlineIntro: "了解 AI工具访问方式、订阅咨询、账号使用支持、交付边界和平台规则。先确认任务、价格、服务范围和合规提醒，再决定是否咨询。",
      skillLearningTitle: "AI教程与实战指南",
      skillLearningIntro: "从 AI 入门、工具使用到视频、图片、语音生成、智能体、自动化工作流与本地部署，按真实任务查找已发布教程和实战课程。",
    ...
    toolDetail: {
      ...
      alipay: "支付宝",
      wechat: "微信",
      buyDownload: "购买并获取下载 ¥{price}",
      buyService: "咨询并购买服务",
      downloadSoftware: "下载应用",
      downloadSkill: "下载 Skill ZIP 包",
      useOnline: "查看服务",
      openVip: "购买并获取下载",
      ...
      productImagesIntro: "展示核心功能、适用场景和交付信息。",
  ...
  en: {
    ...
    toolCard: {
      ...
      deliveryDownload: "Download/setup notes",
      deliverySkill: "ZIP package/setup notes",
      deliveryService: "Service notes",
      deliveryCourse: "Course content",
      compareBeforeBuy: "Review details",
      getFreeTool: "Get free",
    ...
    listing: {
      ...
      aiSkillTitle: "AI Skills",
      aiSkillIntro: "Browse professional Skills for Codex, OpenClaw, Claude Code, Cursor, and other AI agents. Purchase a Skill to access its ZIP package and setup notes.",
      onlineTitle: "AI Account Services",
      onlineIntro: "Review AI account service guidance, subscription support, access notes, delivery scope, pricing context, and platform policy reminders before requesting help.",
      skillLearningTitle: "Practical AI Tutorials and Guides",
      skillLearningIntro: "Learn AI through practical guides for tools, content generation, agents, automation workflows, and local deployment.",
    ...
    toolDetail: {
      ...
      alipay: "Alipay",
      wechat: "WeChat",
      buyDownload: "Buy and get download CNY {price}",
      buyService: "Consult and buy service",
      downloadSoftware: "Download app",
      downloadSkill: "Download Skill ZIP",
      useOnline: "View service",
      openVip: "Buy and get download",
      ...
      productImagesIntro: "Review core features, use cases, and delivery details.",
