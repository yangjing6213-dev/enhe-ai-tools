...
// Adapted from React Bits TargetCursor, licensed MIT + Commons Clause.
// Fixed elements are viewport-relative unless an ancestor establishes a containing block.
